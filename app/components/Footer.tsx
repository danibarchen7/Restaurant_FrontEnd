      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 md:grid-cols-3">
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">Bestellen Sie</h2>
            <div>
          ...
          <div className="space-y-6">
            {formData.items.map((item, index) => (
              <div key={index} className="p-4 border rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block mb-2">Mahlzeit</label>
                    <select
                      value={item.meal}
                      onChange={(e) =>
                      ...
                      required
                    >
                      <option value="">Wählen Sie eine Mahlzeit</option>
                      {isLoading ? (
                        <option>Mahlzeiten werden geladen …...</option>
                      ) : (
            ...
            >
              + Eine weitere Mahlzeit hinzufügen
            </button>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label className="block mb-2 font-medium">Bevorzugte Zeit</label>
              <input
                type="time"
                value={formData.time}
                onChange={(e) =>
        ...
        {/* Contact Us */}
        <div id="contact">
          <h2 className="mb-4 text-xl font-bold">Kontaktieren Sie uns</h2>
          <p className="mb-2">Hofmark 33 | 4742 pram</p>
          <p className="mb-2">Call Us Any</p>
          <p className="mb-2">Mobile: 0690/105 55 199</p>
          <p className="mb-2">Phone: 07736/6140</p>
        ...
        {/* Quick Links & Hours */}
        <div>
          <h2 className="mb-4 text-xl font-bold">Direktlinks</h2>
          ...
          <h2 className="mb-2 text-xl font-bold">Öffnungszeiten</h2>
          <p className="mb-1">6 GEÖFFNETE TAGE</p>
          <p className="mb-1">
